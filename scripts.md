...
t" | grep -- "-All" | tr -d '",' | tee /dev/tty | xargs -I {} aws lambda invoke --function-name {} --log-type Tail WORKSPACE_PATH/tempo/{}.log --profile rentek --cli-read-timeout 120
```
...
```
sudo chown -R HOST_USER:HOST_GROUP WORKSPACE_PATH
```
